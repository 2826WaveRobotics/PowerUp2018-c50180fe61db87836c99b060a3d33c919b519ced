...
//
//	operatorY->WhenPressed(new SetElbow(0));
//	operatorB->WhenPressed(new SetElbow(140));
//	operatorX->WhenPressed(new SetElbow(15));
//	operatorA->WhenPressed(new SetElbow(160));
...
//	driverY->WhenPressed(new Shift(false));
//	driverX->WhenPressed(new Shift(true));
//
//	driverA->WhenPressed(new DeployTRexArms());
