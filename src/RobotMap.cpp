...
int CANTalon_elbowElbowRight		= 32;
int CANTalon_elbowElbowLeft			= 32;
int CANTalon_KirbyIntakeRight		= 32;
int CANTalon_KirbyIntakeLeft		= 32;
int CANTalon_elevatorElevatorRight	= 32; // it actually is 32
...
int CANTalon_elbowElbowLeft			= 24;
int CANTalon_KirbyIntakeRight		= 18;
int CANTalon_KirbyIntakeLeft		= 26;
int CANTalon_elevatorElevatorRight	= 24;
...
//    //lw->AddActuator("Drive", "Shifter", driveShifter);
   ...
   // lw->AddActuator("Elbow", "ElbowRotate", elbowElbowRotate);
    ...
    elbowElbowPosition.reset(new frc::Encoder(4, 5, false, frc::Encoder::k4X));
