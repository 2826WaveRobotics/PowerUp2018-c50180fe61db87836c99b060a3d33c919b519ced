...
//	table->PutNumber("camMode",1);
	...
	//AUTO MODE OPTION 1
	//Options: Do Nothing, Drive Straight, Switch+Cube, Scale, Switch Timed
//	m_autoMode.AddDefault("Default to Do Nothing", new AutoCurve(.3, 90));
//	m_autoMode.AddObject("Drive Straight", new AutoDrive(150, 0.8, 0) );
//	m_autoMode.AddObject("Switch and Cube", new RightSwitchExchangeAuto());
//	m_autoMode.AddObject("Scale", new RightScaleAuto());
//	m_autoMode.AddObject("Switch Timed", new RightSwitchTimedAuto());
...
void Robot::AutonomousInit() {
	...
	if(m_autoType == p_doNothing){
	    ...
	    autonomousCommand = new AutoDriveTimed(-0.5, 0, 7);
