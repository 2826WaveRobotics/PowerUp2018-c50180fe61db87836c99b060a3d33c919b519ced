...
#include "Subsystems/IronCross.h"
#include "Subsystems/Kirby.h"
...
public:
	...
	frc::SendableChooser<frc::Command*> m_autoMode;
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	static std::shared_ptr<Drive> drive;
	static std::shared_ptr<Kirby> kirby;
	static std::shared_ptr<IronCross> ironCross;
