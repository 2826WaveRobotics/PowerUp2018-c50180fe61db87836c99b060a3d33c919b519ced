...
//
//	std::cout << "Correction: " << correction << " Dist Diff: " << distanceDiff <<
//			"  Velocity:  " << velocity << std::endl;
//
//	//Slow down
//	if((distanceDiff < (fabs(distance/2))) && (velocity > 12)){
//		power = power*slowdownConst;
//		std::cout << " ----------------- Slowdown -------------------- " << std::endl;
//	}
//
//	//Set Power
//	if((velocity < 35) && (distanceDiff < 10)){
//		stopDist = true;
//		if((power > 0)){
//			SetSidePower(power, power);
//			std::cout << "   tripping on 1  " << std::endl;
//		}
//		else{
//			if(velocity > 1){
//				std::cout << " In while loop " << std::endl;
//				SetSidePower(1, 1);
//				velocity = fabs(GetVelocity());
//				std::cout << "  Velocity:  " << velocity;
//				Wait(.01);
//			}
//			std::cout << "  tripping on 2  " << std::endl;
//		}
//	}
//
//	if(stopDist == false){
...
double DrivePID::CheckPower(double maxPower, double minPower, double distanceToDrive, double midpointMultiplier){
	bool forward = distanceToDrive > 0 ? true : false; //if distance is positive, we are moving forward
	double rightDist = GetRightEncoder();
	double leftDist = GetLeftEncoder()*(-1);
	double m_distanceTraveled = GetDistance();

	double distance = fabs(m_distanceTraveled);
